...
1. **Run audit first**: Follow the audit process from `.claude/slides/commands/audit-slide.md` to identify all violations.
2. **Load rules**: Read `.claude/slides/skills/visual-design-rules.md`.
3. **Apply fixes** for each violation found:
   ...
   - **Missing explanation**: Add `show_explanation(textwrap.dedent("""\..."""))`
