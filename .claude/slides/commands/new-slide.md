...
1. **Load rules**: Read `.claude/slides/skills/visual-design-rules.md` for the full design ruleset.
2. **Read style conventions**: Read `.claude/slides/skills/style-conventions.md`.
...
## Constraints
- Follow ALL rules from `.claude/slides/skills/visual-design-rules.md`
