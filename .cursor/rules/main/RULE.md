...
For architectural reference, inspect `documentation/manuals/stx_manual_intro/` (comprehensive feature showcase) or `documentation/template_project/` (starter template).
