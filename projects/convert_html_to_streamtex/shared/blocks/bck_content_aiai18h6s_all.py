...
def build():
    ...
    st_space(size=3)
    st_space(size=3)
    st_write(s.project.pres.titles.h4 + s.project.colors.burnt_orange, "Showcase (90') ", tag=t.h4)
    ...
    st_space(size=3)
    st_write(s.project.pres.titles.h4 + s.project.colors.burnt_orange, "Intuitive introduction to AI  (45')Practice and understanding of deep learning basic concepts using the MNIST running example ", tag=t.h4)
    st_space(size=3)
    st_space(size=3)
    st_space(size=3)
    st_space(size=3)
    ...
    st_write(
        ...
        (s.project.colors.burnt_orange, "Practice and understanding of deep learning basic concepts "),
        (s.project.colors.deep_red, "- ctnd "),
        tag=t.h4,
    )
    st_space(size=3)
    st_space(size=3)
    ...
    st_write(
        s.project.pres.paragraphs.p_xl,
        (s.project.colors.burnt_orange, "Practice and understanding ofother "),
        (s.project.colors.deep_red, "deep learning architectures"),
        tag=t.h4,
    )
    st_space(size=3)
    st_space(size=3)
    ...
    st_write(
        s.project.pres.paragraphs.p_xl,
        (s.project.colors.forest_green, "Society"),
        (s.project.colors.burnt_orange, " & Artificial Intelligence "),
        tag=t.h4,
    )
    st_space(size=3)
    ...
    st_write(
        s.project.pres.paragraphs.p_xl,
        (s.project.colors.gold, "Artificial Intelligence"),
        (s.project.colors.bright_red, "Ethics"),
        (s.project.colors.burnt_orange, " & "),
        (s.project.colors.forest_green, "Society"),
        tag=t.h4,
    )
    st_write(s.project.pres.titles.h4 + s.project.colors.burnt_orange, "Interactive Workshop  ", tag=t.h4)
    st_space(size=3)
    st_space(size=3)
    st_space(size=3)
    st_space(size=1)
