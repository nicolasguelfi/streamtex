...
def build():
    ...
    st_space(size=3)
    st_write(s.project.pres.titles.h4 + s.project.colors.dark_purple, "Scientific & Technical Basics (60') ", tag=t.h4)
    st_space(size=4)
    ...
    st_space(size=3)
    st_write(s.project.pres.titles.h4 + s.project.colors.burnt_orange, "DEEP LEARNING PART 4 (30') ", tag=t.h4)
    ...
    st_space(size=3)
    st_space(size=3)
    st_write(s.project.pres.titles.h4 + s.project.colors.burnt_orange, "Break (60') ", tag=t.h4)
    st_space(size=3)
    st_space(size=3)
    st_space(size=1)
