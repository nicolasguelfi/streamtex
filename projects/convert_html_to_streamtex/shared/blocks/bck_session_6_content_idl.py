...
def build():
    ...
    st_space(size=3)
    st_write(s.project.pres.titles.h4 + s.project.colors.burnt_orange, "ETHICS (90') ", tag=t.h4)
    ...
    st_write(
        ...
        (s.project.colors.burnt_orange, " on AI & Ethics "),
        (s.project.colors.burnt_orange, "(60') "),
        tag=t.h4,
    )
    st_space(size=3)
