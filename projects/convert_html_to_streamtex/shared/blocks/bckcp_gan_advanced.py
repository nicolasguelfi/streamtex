...
def build():
    st_space(size=1)
    st_write(s.project.doc.titles.h2, "10.5. GAN - Generative Adversarial Network ", tag=t.h2, toc_lvl="+1")
    st_space(size=1)
    st_space(size=1)
    with st_grid(cols=2, grid_style=s.project.doc.grids.gap) as g:
        ...
        with g.cell():
            st_write(s.project.doc.tables.cell, "Jeff Heatont81_558_class_07_1_gan_intro.ipynb ", "t81_558_class_07_2_train_gan.ipynb ")
        with g.cell():
