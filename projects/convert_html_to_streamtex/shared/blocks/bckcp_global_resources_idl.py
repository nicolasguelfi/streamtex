...
def build():
    st_space(size=1)
    st_write(s.project.doc.titles.h1, "7. Global Recommended/Used sources ", tag=t.h1, toc_lvl="1")
    st_space(size=1)
    ...
    st_space(size=1)
    st_space(size=1)
    st_write(s.project.doc.titles.h2, "7.5. Benchmarks ", tag=t.h2, toc_lvl="+1")
    st_space(size=1)
    ...
    st_space(size=1)
    st_space(size=1)
    st_write(s.project.doc.titles.h2, "7.6. Online AI trainings ", tag=t.h2, toc_lvl="+1")
    st_space(size=1)
    st_write(s.project.doc.paragraphs.p_body + s.project.colors.link_blue, "Coursera Deep Learning Specialization", link="https://www.coursera.org/specializations/deep-learning")
    st_space(size=1)
    st_space(size=1)
    st_space(size=1)
    st_space(size=1)
