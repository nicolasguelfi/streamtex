...
def build():
    ...
    st_space(size=1)
    st_write(s.project.doc.paragraphs.p_body + s.project.colors.link_blue, "Training Drive Folder", link="https://drive.google.com/drive/folders/19Z-DYw_QQLvrErXnJGT4I-_bWa6TS86Y?usp=sharing")
    st_space(size=1)
    st_space(size=1)
    st_space(size=1)
    st_space(size=1)
