...
def build():
    ...
    with st_grid(cols=6, grid_style=s.project.doc.grids.gap) as g:
        ...
        with g.cell():
            st_write(s.project.doc.tables.cell + s.project.colors.gold + s.bold, "2/28/2025")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.bold, "1")
        with g.cell():
        ...
        with g.cell():
            st_write(s.project.doc.tables.cell + s.project.colors.gold + s.bold, "3/3/2025")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.bold, "2")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.project.colors.gold + s.bold, "break")
        ...
        with g.cell():
            st_write(s.project.doc.tables.cell + s.project.colors.bright_red + s.bold, "Prompt Engineering")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.project.colors.gold + s.bold, "2:00PM")
        with g.cell():
        ...
        with g.cell():
            st_write(s.project.doc.tables.cell + s.project.colors.gold + s.bold, "3/31/2025")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.bold, "3")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.project.colors.gold + s.bold, "break")
        ...
        with g.cell():
            st_write(s.project.doc.tables.cell + s.project.colors.gold + s.bold, "Projects Presentations & Discussions")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.project.colors.gold + s.bold, "2:00PM")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.project.colors.gold + s.bold, "90")
        ...
        with g.cell():
            st_write(s.project.doc.tables.cell + s.project.colors.gold + s.bold, "4/28/2025")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.bold, "4")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.project.colors.gold + s.bold, "break")
        ...
        with g.cell():
            st_write(s.project.doc.tables.cell + s.project.colors.gold + s.bold, "15")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.bold, "795")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.project.colors.gold + s.bold, "4/28/2025")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.bold, "4")
