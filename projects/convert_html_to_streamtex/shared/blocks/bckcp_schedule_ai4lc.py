...
def build():
    st_space(size=1)
    st_write(s.project.doc.titles.h1, "4. Schedule ", tag=t.h1, toc_lvl="1")
    st_space(size=1)
    with st_grid(cols=6, grid_style=s.project.doc.grids.gap) as g:
        ...
        with g.cell():
            st_write(s.project.doc.tables.cell + s.project.colors.gold + s.bold, "11/15/2024")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.bold, "1")
        with g.cell():
        ...
        with g.cell():
            st_write(s.project.doc.tables.cell + s.project.colors.gold + s.bold, "6:15PM")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.project.colors.gold + s.bold, "45")
        with g.cell():
        ...
        with g.cell():
            st_write(s.project.doc.tables.cell + s.project.colors.gold + s.bold, "DEEP LEARNING")
        with g.cell():
        ...
        with g.cell():
            st_write(s.project.doc.tables.cell + s.bold, "315")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.project.colors.gold + s.bold, "11/22/2024")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.bold, "2")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.project.colors.gold + s.bold, "break")
        ...
        with g.cell():
            st_write(s.project.doc.tables.cell + s.project.colors.gold + s.bold, "15")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.bold, "330")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.project.colors.gold + s.bold, "11/22/2024")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.bold, "2")
        ...
        with g.cell():
            st_write(s.project.doc.tables.cell + s.project.colors.gold + s.bold, "SESSION END")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.project.colors.gold + s.bold, "4:15PM")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.project.colors.gold + s.bold, "0")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.bold, "390")
        ...
        with g.cell():
            st_write(s.project.doc.tables.cell + s.project.colors.gold + s.bold, "120")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.bold, "705")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.project.colors.gold + s.bold, "12/6/2024")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.bold, "4")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.project.colors.gold + s.bold, "break")
        ...
        with g.cell():
            st_write(s.project.doc.tables.cell + s.project.colors.gold + s.bold, "90")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.bold, "870")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.project.colors.gold + s.bold, "12/20/2024")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.bold, "5")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.project.colors.gold + s.bold, "break")
        ...
        with g.cell():
            st_write(s.project.doc.tables.cell + s.project.colors.gold + s.bold, "15")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.bold, "885")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.project.colors.gold + s.bold, "12/20/2024")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.bold, "5")
