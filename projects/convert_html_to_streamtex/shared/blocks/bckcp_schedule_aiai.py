...
def build():
    ...
    with st_grid(cols=7, grid_style=s.project.doc.grids.gap) as g:
        ...
        with g.cell():
            st_write(s.project.doc.tables.cell + s.project.colors.gold + s.bold, "4/23/2024")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.bold, "1")
        with g.cell():
        ...
        with g.cell():
            st_write(s.project.doc.tables.cell + s.project.colors.gold + s.bold, "8:15PM")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.project.colors.gold + s.bold, "45")
        with g.cell():
        ...
        with g.cell():
            st_write(s.project.doc.tables.cell + s.project.colors.gold + s.bold, "4/24/2024")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.bold, "2")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.bold, "2")
        ...
        with g.cell():
            st_write(s.project.doc.tables.cell + s.bold, "15")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.project.colors.gold + s.bold, "4/25/2024")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.bold, "3")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.bold, "2")
        ...
        with g.cell():
            st_write(s.project.doc.tables.cell + s.bold, "3")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.project.colors.gold + s.bold, "DEEP LEARNING PART 3")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.project.colors.gold + s.bold, "6:00PM")
        with g.cell():
        ...
        with g.cell():
            st_write(s.project.doc.tables.cell + s.bold, "5")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.project.colors.gold + s.bold, "DEEP LEARNING PART 4")
        with g.cell():
        ...
        with g.cell():
            st_write(s.project.doc.tables.cell + s.project.colors.gold + s.bold, "0")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.bold, "0")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.project.colors.gold + s.bold, "4/25/2024")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.bold, "3")
        ...
        with g.cell():
            st_write(s.project.doc.tables.cell + s.bold, "15")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.project.colors.gold + s.bold, "4/26/2024")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.bold, "4")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.bold, "2")
        ...
        with g.cell():
            st_write(s.project.doc.tables.cell + s.bold, "3")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.project.colors.gold + s.bold, "Society")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.project.colors.gold + s.bold, "6:45PM")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.project.colors.gold + s.bold, "60")
        ...
        with g.cell():
            st_write(s.project.doc.tables.cell + s.bold, "55")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.project.colors.gold + s.bold, "4/26/2024")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.bold, "4")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.bold, "7")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.project.colors.gold + s.bold, "AIAI Survey and Discussion")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.project.colors.gold + s.bold, "8:40PM")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.project.colors.gold + s.bold, "10")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.bold, "65")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.project.colors.gold + s.bold, "4/26/2024")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.bold, "4")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.bold, "8")
        with g.cell():
            st_write(s.project.doc.tables.cell, "DLH Training Survey ")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.project.colors.gold + s.bold, "8:50PM")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.project.colors.gold + s.bold, "10")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.bold, "75")
        ...
        with g.cell():
            st_write(s.project.doc.tables.cell, "SESSION END ")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.project.colors.gold + s.bold, "9:00PM")
        with g.cell():
            st_write(s.project.doc.tables.cell + s.project.colors.gold + s.bold, "0")
