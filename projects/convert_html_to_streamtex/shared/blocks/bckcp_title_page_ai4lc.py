...
def build():
    ...
    st_write(s.project.doc.paragraphs.p_lg + s.project.colors.dark_purple + s.bold, "Languages & Cultures ")
    st_write(s.project.doc.paragraphs.p_lg + s.project.colors.navy_blue, "Master S1 / 2TU")
    st_space(size=4)
