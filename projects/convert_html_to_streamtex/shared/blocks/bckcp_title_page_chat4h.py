...
def build():
    ...
    st_space(size=2)
    st_write(s.project.doc.paragraphs.p_lg + s.bold, "Elements of AI")
    st_write(s.project.doc.paragraphs.p_lg + s.project.colors.gold + s.bold, "Designing Your Own  ")
    st_write(s.project.doc.paragraphs.p_lg + s.project.colors.forest_green + s.bold, "Generative AI Assistant ")
    st_write(s.project.doc.paragraphs.p_lg + s.project.colors.bright_red + s.bold + s.italic, "From Concept to Creation")
    st_space(size=1)
    st_space(size=1)
