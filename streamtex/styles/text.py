...
class Sizes:
    ...
    GIANT_em_size   = Style("font-size: 12em;",   "GIANT_em_size")
    Giant_em_size   = Style("font-size: 10em;",  "Giant_em_size")
    ...
    huge_em_size    = Style("font-size: 4em;",   "huge_em_size")
    LARGE_em_size   = Style("font-size: 3em;",   "LARGE_em_size")
    Large_em_size   = Style("font-size: 2em;",   "Large_em_size")
    large_em_size   = Style("font-size: 1.5em;", "large_em_size")
    big_em_size     = Style("font-size: 1em;",   "big_em_size")
    medium_em_size  = Style("font-size: 0.75em;","medium_em_size")
    little_em_size  = Style("font-size: 0.5em;", "little_em_size")
    small_em_size   = Style("font-size: 0.4em;", "small_em_size")
    tiny_em_size    = Style("font-size: 0.25em;","tiny_em_size")

    GIANT_px_size   = Style("font-size: 196px;", "GIANT_px_size")
    Giant_px_size   = Style("font-size: 160px;", "Giant_px_size")
    ...
    huge_px_size    = Style("font-size: 64px;",  "huge_px_size")
    LARGE_px_size   = Style("font-size: 48px;",  "LARGE_px_size")
    Large_px_size   = Style("font-size: 32px;",  "Large_px_size")
    large_px_size   = Style("font-size: 24px;",  "large_px_size")
    big_px_size     = Style("font-size: 16px;",  "big_px_size")
    medium_px_size  = Style("font-size: 12px;",  "medium_px_size")
    little_px_size  = Style("font-size: 8px;",   "little_px_size")
    small_px_size   = Style("font-size: 6px;",   "small_px_size")
    tiny_px_size    = Style("font-size: 4px;",   "tiny_px_size")

    GIANT_size      = Style("font-size: var(--stx-GIANT-size, 196pt);", "GIANT_size")
    Giant_size      = Style("font-size: var(--stx-Giant-size, 160pt);", "Giant_size")
    giant_size      = Style("font-size: var(--stx-giant-size, 128pt);", "giant_size")
    HUGE_size       = Style("font-size: var(--stx-HUGE-size, 96pt);",   "HUGE_size")
    Huge_size       = Style("font-size: var(--stx-Huge-size, 80pt);",   "Huge_size")
    huge_size       = Style("font-size: var(--stx-huge-size, 64pt);",   "huge_size")
    LARGE_size      = Style("font-size: var(--stx-LARGE-size, 48pt);",  "LARGE_size")
    Large_size      = Style("font-size: var(--stx-Large-size, 32pt);",  "Large_size")
    large_size      = Style("font-size: var(--stx-large-size, 24pt);",  "large_size")
    big_size        = Style("font-size: var(--stx-big-size, 16pt);",    "big_size")
    medium_size     = Style("font-size: var(--stx-medium-size, 12pt);", "medium_size")
    little_size     = Style("font-size: var(--stx-little-size, 8pt);",  "little_size")
