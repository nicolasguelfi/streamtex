...
""")
    ...
    show_explanation(
        "This very project (test_project_advanced) uses both registries. "
...
tests/
  ...
  test_project_intro/           # Uses shared blocks via LazyBlockRegistry
  test_project_advanced/        # Uses shared blocks via LazyBlockRegistry
""", language="text")
    st_space("v", 1)
